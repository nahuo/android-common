...
/**
 * 带水波点击效果的ImageButton
 * Created by JorsonWong on 2015/7/14
 */
public class RippleImageButton extends ImageButton {
    ...
    private final Runnable runnable = new Runnable() {
        public void run() {
            RippleImageButton.this.invalidate();
        }
    };
        ...
        if (!this.isInEditMode()) {
            ...
            this.gestureDetector = new GestureDetector(context, new SimpleOnGestureListener() {
                public void onLongPress(MotionEvent event) {
                    ...
                    RippleImageButton.this.animateRipple(event);
                    RippleImageButton.this.sendClickEvent(Boolean.valueOf(true));
                }
